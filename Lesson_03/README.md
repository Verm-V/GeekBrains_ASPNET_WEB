...
- [ ] Необходимо реализовать ASP.NET Core MVC приложение 
с разделением логики на уровень контроллеров, сервисов и репозиториев.  
- [ ] Для уровня сервисов и репозиториев использовать интерфейсы.  
- [ ] Приветствуется соблюдение принципов SOLID, 
а также применение Dependency Injection встроенными средствами платформы ASP.NET Core..  
  
- [ ] Предлагается создать api для работы с коллекцией persons:  
